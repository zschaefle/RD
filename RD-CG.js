...
var woodstick = new item(1, 0, 1, 1, 2, "Wooden Stick", "woodstick", "It might not be the best sword, but hey, it's worth a try.");
...
function genRoom() {
    ...
    if (rand(2) == 1){
        var minion = minions[rand(minions.length)-1];
